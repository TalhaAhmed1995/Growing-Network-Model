...
def plot(xData, yData, plotType, xLab, yLab, title, legend, multiX=False, multiY=False, loc=2, log=False, figure=True):
    ...
    if log: # The axes are scaled logarithmically if specified
